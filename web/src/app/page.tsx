...
import { ThemeModesSection } from "@/components/theme-modes-section";
import { CustomizeSection } from "@/components/customize-section";
import { FinalCTASection } from "@/components/final-cta-section";
import { DemoStateProvider } from "@/components/demo/demo-state-context";
        ...
        <main className="min-h-[85vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="flex flex-col items-center text-center max-w-2xl lg:max-w-3xl w-full">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-800 dark:text-slate-200 mb-7 sm:mb-8 leading-7 sm:leading-8 px-4">
              Browser extension that toggles dark mode on any site. Adjust brightness, contrast,
